...
(function ($) {
  ...
  var $mainMenuToggle = $(".menu-toggle");
  var menuOpen = false;
  $mainMenuToggle.on("click", function () {
    if (!menuOpen) {
      var menuTl = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline();
      menuTl.to(".magic-menu", {
        height: "100%",
        display: "block",
        duration: 0
      });
      menuTl.fromTo([".magic-menu__underlay", ".magic-menu__background"], {
        height: 0,
      ...
      menuTl.fromTo(".magic-menu .main-menu li", {
        opacity: 0,
        x: -100
      }, {
        opacity: 1,
      ...
      menuTl.fromTo(".magic-menu .portrait", {
        opacity: 0,
        x: 50
      }, {
        opacity: 1,
      ...
      var _menuTl = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline();

      _menuTl.fromTo(".magic-menu .portrait", {
        opacity: 1,
        x: 0
      }, {
        opacity: 0,
      ...
      _menuTl.to(".magic-menu .text", {
        opacity: 0,
        y: 50,
        duration: 0.3
      }, "-=.3");

      _menuTl.to(".magic-menu .main-menu li", {
        opacity: 0,
        x: -100,
        duration: 0.2,
        stagger: {
      ...
      _menuTl.to([".magic-menu__background", ".magic-menu__underlay"], {
        duration: 0.8,
        height: 0,
        transformOrigin: "right top",
        skewY: 4,
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        if (data.acf.bild_1 !== false) {
          ...
          Object.entries(data.acf).forEach(function (el) {
            console.log(el);
  ...
  if (document.querySelector(".experience-animation") !== null) {
    var img = document.querySelector(".experience-animation .video");
    var targets = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(".ani");
    targets.forEach(function (ani, i) {
      // not the last slide
      if (i + 1 < targets.length) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(ani, {
          autoAlpha: 0,
          scrollTrigger: {
            trigger: ".slide" + (i + 1),
            start: "center center",
    ...
    if (document.querySelector(".experience-animation")) {
      ...
      var currentFrame = function currentFrame(index) {
        return "/wp-content/themes/usomo/assets/img/animation/frame_".concat((index + 1).toString().padStart(5, "0"), ".png");
      };
    ...
    var video = document.querySelector(".headphones .video");
